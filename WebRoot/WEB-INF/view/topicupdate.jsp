...
function checkpost(){
  ...
  <body>
	...
	<form name="topic" action="bbs/topic.do?method=update" method="post" class="txt">
	<input type="hidden" name="forumID" value="${forum.id}">
	<input type="hidden" name="topicID" value="${topic.topicID}">
	<input type="hidden" name="account" value="${topic.author.account}"/>  
	
	<table cellspacing="0" cellpadding="0" width="100%">
	
		    <tr>
		      <td class="txtsty fsize1" style="BORDER-BOTTOM:#a6cbe7 1px solid"><b>修改帖子</b></td>
		    </tr>
		    <tr>
		      <td bgcolor="#f2f8ff">
				<center>
				<table>
				  <tr><td><span class="fsize"> 标题：</span><input type="text" id="title" name="title" size="70" maxlength="50" value="${topic.title}"/></td></tr>
